...
"""
File: python_driver_b9.py
Title: IMU Serial Reader & Parser (Python 2/3)
Deps: pyserial  (pip install pyserial)

Usage (Linux):
  python python_driver_b9.py --port /dev/ttyUSB0 --baud 921600

Usage (Windows):
  python python_driver_b9.py --port COM5 --baud 921600
